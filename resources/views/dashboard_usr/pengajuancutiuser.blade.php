...
<div class="mb-8 px-4">
    <h1 class="text-md md:text-xl font-semibold text-gray-400 mb-4">Pengajuan Cuti</h1>
    <div class="grid grid-cols-1 gap-4 mx-auto max-w-5xl">
        ...
        <div class="bg-[#1E293B] p-4 rounded-xl shadow-md text-white w-full">
            <div class="flex justify-between items-center mb-4">
                <i class="fa-solid fa-calendar-days text-3xl text-gray-500"></i>
            </div>
            <div class="text-left">
                <h5 class="text-3xl font-bold">{{ $totalCuti }}</h5>
                <h3 class="text-base font-semibold text-gray-400 mt-1">Total Pengajuan Cuti</h3>
            </div>
        </div>
