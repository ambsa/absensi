...
<div class="mb-8 px-4">
    <h1 class="text-md md:text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Pengajuan Cuti</h1>
    <div class="grid grid-cols-1 gap-4 mx-auto max-w-5xl">
        <!-- Total Pengajuan Cuti (Full Width) -->
        <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md text-gray-800 dark:text-gray-200 w-full">
            <div class="flex justify-between items-center mb-4">
                <i class="fa-solid fa-calendar-days text-3xl text-gray-500 dark:text-gray-400"></i>
            </div>
            <div class="text-left">
                <h5 class="text-3xl font-bold">{{ $totalCuti }}</h5>
                <h3 class="text-base font-semibold text-gray-400 dark:text-gray-500 mt-1">Total Pengajuan Cuti</h3>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md text-gray-800 dark:text-gray-200 w-full">
                ...
                <div class="text-left">
                    <h5 class="text-3xl font-bold">{{ $cutiPending }}</h5>
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md text-gray-800 dark:text-gray-200 w-full">
                ...
                <div class="text-left">
                    <h5 class="text-3xl font-bold">{{ $cutiApproved }}</h5>
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md text-gray-800 dark:text-gray-200 w-full">
                ...
                <div class="text-left">
                    <h5 class="text-3xl font-bold">{{ $cutiRejected }}</h5>
