...
<div class="overflow-x-auto">
    ...
    <div class="mb-4 flex flex-col sm:flex-row justify-between items-center">
        ...
        <!-- Tombol Tambah Cuti (Dikomentari) -->
        ...
        <div class="shadow-md overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
            <table id="cuti-table" class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        <th class="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-[50px]">
                            No
                        </th>
                        <th class="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-[100px]">
                            ID
                        </th>
                        ...
                        <th class="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-[120px]">
                            Tanggal Mulai
                        </th>
                        <th class="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-[120px]">
                            Tanggal Selesai
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-200">
                            ...
                            <td class="px-3 py-2 text-center whitespace-nowrap text-sm">
                                ...
                                @elseif ($item->status == 'approved')
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">Approved</span>
                                @else
                            ...
                            <td class="px-3 py-2 text-center whitespace-nowrap relative text-sm">
                                ...
                                <div id="cuti-dropdown-{{ $item->id_cuti }}"
                                    ...
                                    <div class="py-1">
                                        <!-- Hapus -->
                                        <form id="delete-form-{{ $item->id_cuti }}" action="{{ route('admin.cuti.destroy', $item->id_cuti) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
