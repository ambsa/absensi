        ...
        <form action="{{ route('admin.cuti.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <select id="id_jenis_cuti" name="id_jenis_cuti"
                    class="mt-1 block w-full px-3 py-2 border border-gray-600 bg-[#1E293B] text-gray-400 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    <option value="" class="text-gray-400">Pilih Jenis Cuti</option>
