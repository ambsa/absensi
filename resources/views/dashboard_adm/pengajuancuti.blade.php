 ...
 <div class="mb-8 px-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 justify-items-center mx-auto max-w-5xl">
        ...
        <div class="bg-[#1E293B] p-3 sm:p-4 rounded-xl shadow-md max-w-64 text-white w-full">
            ...
            <div class="text-left">
                <h5 class="text-2xl sm:text-3xl font-bold">{{ $cutiPending }}</h5>
        ...
        <div class="bg-[#1E293B] p-3 sm:p-4 rounded-xl shadow-md max-w-64 text-white w-full">
            ...
            <div class="text-left">
                <h5 class="text-2xl sm:text-3xl font-bold">{{ $cutiApproved }}</h5>
        ...
        <div class="bg-[#1E293B] p-3 sm:p-4 rounded-xl shadow-md max-w-64 text-white w-full">
            ...
            <div class="text-left">
                <h5 class="text-2xl sm:text-3xl font-bold">{{ $cutiRejected }}</h5>
