...
class MiniadminWfhController extends Controller
{
public function index(Request $request)
    {
        ...
        return view('miniadmin.wfh.index', compact('wfhs'));
    }
    ...
    {
        return view('miniadmin.wfh.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('miniadmin.wfh.index')->with('success', 'Status pengajuan WFH berhasil dikirim.')->with('alertType', 'success');
    }
    ...
    public function show($id)
    {
        ...
        return view('miniadmin.wfh.show', compact('wfh'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('miniadmin.wfh.index')->with('success', 'Status pengajuan WFH berhasil diperbarui.')->with('alertType', 'success');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('miniadmin.wfh.index')->with('success', 'Status pengajuan WFH berhasil dihapus.')->with('alertType', 'success');
    }
